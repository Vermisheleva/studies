public class MPPPT {
    ...
    public MPPPT(int n, double a, double b, double u0) {
        N = n;
        this.a = a;
        this.b = b;
        this.h = (b - a) / N;
    ...
    public double euler(int i){
        return y[i] + (h / 2) * f(y[i], t[i]);
    }
    ...
    public static void main(String[] args){
        MPPPT obj = new MPPPT(10, 1., 1.5, 0.);
        obj.solve();
    }
}
